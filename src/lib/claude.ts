...
interface ExplorationContext {
  ...
  classification?: QueryClassification; // NEW: pass classification for dynamic branching
  exploreType?: FollowUpType; // NEW: what type of exploration the user requested
}
...
interface GeneratedBranch {
  ...
  summary: string;
  depthPreview?: string;
  followUpType: FollowUpType; // NEW: required - what this branch explores
}
