  ...
  const features = [
    {
      ...
      gradient: 'from-[var(--mint-accent-1)] to-[var(--mint-accent-3)]',
    },
    {
      icon: Zap,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-[var(--mint-accent-1)] to-[var(--mint-accent-3)] border border-[var(--mint-accent-2)] mb-4">
            <BookOpen className="w-12 h-12 text-[var(--mint-accent-1)]" />
          </div>
          ...
          <p className="text-xl text-[var(--mint-text-secondary)] max-w-3xl mx-auto">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 bg-[var(--mint-elevated)] backdrop-blur rounded-2xl border border-[var(--mint-elevated)] hover:border-[var(--mint-accent-2)] transition-all"
                >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {resources.map((resource, index) => {
              ...
              return (
                ...
                >
                  <Icon className="w-10 h-10 text-[var(--mint-accent-1)] mb-4" />
        ...
        >
          <Sparkles className="w-12 h-12 text-[var(--mint-accent-1)] mx-auto mb-4" />
          ...
          <Link
            href="/explore"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[var(--mint-accent-1)] to-[var(--mint-accent-3)] hover:shadow-lg hover:shadow-[0_0_24px_var(--mint-accent-glow)] rounded-xl text-white font-medium transition-all hover:scale-105"
          >
            Start Exploring
