...
export default function Home() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-950/20 via-slate-950 to-violet-950/20"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-6">
              ...
              <button className="px-4 py-2 rounded-lg border border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 transition-all text-sm">
                Sign In
              </button>
            </nav>
          </div>
        ...
        {nodes.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center max-w-4xl px-6">
              ...
              <h1 className="text-5xl font-bold mb-4 animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
              ...
              <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom duration-1000 delay-400">
                Ask any question and watch as an interactive neural network unfolds.
                <br />
                Discover connections, dive deeper, and build your understanding.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group relative p-6 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom duration-1000 delay-800">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-2">Start Simple</h3>
                ...
                <div className="group relative p-6 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-violet-500/20 hover:border-violet-500/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom duration-1000 delay-900">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-2">Go Deeper</h3>
                    <p className="text-slate-400 text-sm">
                ...
                <div className="group relative p-6 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-blue-500/20 hover:border-blue-500/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom duration-1000 delay-1000">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-2">Build Your Map</h3>
                    <p className="text-slate-400 text-sm">
