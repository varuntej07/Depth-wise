...
export function SignInButton() {
  return (
    <button
      ...
      className="group relative px-4 py-2 rounded-lg border border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 transition-all text-xs sm:text-sm overflow-hidden"
    >
